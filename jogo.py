...
#janela
janela_aberta = True
#relogio para contar o tempo
clock = pygame.time.Clock()
while janela_aberta :
    #FPS
    clock.tick(60)
    #delay para diminuir a velocidade
    pygame.time.delay(30)

    #atender cada um da fila
    for event in pygame.event.get():
        ...
        dano = pygame.sprite.groupcollide(grupoDeTiro, grupoDecolisao, True, True)
